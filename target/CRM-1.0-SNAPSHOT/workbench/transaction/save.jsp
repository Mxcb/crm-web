...
<script>
	$(function(){
		...
		$("#create-transactionStage").change(function () {
			...
			var json={
				<c:forEach items="${mapBundle}" var="m">
					"${m.key}":${m.value},
				</c:forEach>
			}
...
<body>
	...
	<form class="form-horizontal" id="tranForm" role="form" style="position: relative; top: -30px;" action="workbench/transaction/save.do" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单">
				<input type="hidden" name="activityId" value="6724e015b10b4806873e24bde3cf559d">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactId" value="4192a42148a948128cd2589a026d88a4">
			</div>
		</div>
